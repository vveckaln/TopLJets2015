...
CLUSTERID=$1
PROCID=$2
echo -e "L_pull_angle_allconst_reco_scnd_leading_jet_leading_jet_DeltaRTotal\t${PROCID}\t"`date` >> /afs/cern.ch/work/v/vveckaln/private/CMSSW_8_0_26_patch1/src/TopLJets2015/TopAnalysis/condor/makeplots/registry_cflip_$CLUSTERID.txt
