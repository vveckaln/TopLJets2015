...
CLUSTERID=$1
PROCID=$2
echo -e "M_pull_angle_hadWPtgt50p0GeV_gen_scnd_leading_jet_had_t_DeltaRle1p0\t${PROCID}\t"`date` >> /afs/cern.ch/work/v/vveckaln/private/CMSSW_8_0_26_patch1/src/TopLJets2015/TopAnalysis/condor/makeplots/registry_nominal_$CLUSTERID.txt
