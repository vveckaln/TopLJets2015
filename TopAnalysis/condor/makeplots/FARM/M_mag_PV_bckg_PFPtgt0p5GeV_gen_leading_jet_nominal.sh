...
CLUSTERID=$1
PROCID=$2
echo -e "M_mag_PV_bckg_PFPtgt0p5GeV_gen_leading_jet\t${PROCID}\t"`date` >> /afs/cern.ch/work/v/vveckaln/private/CMSSW_8_0_26_patch1/src/TopLJets2015/TopAnalysis/condor/makeplots/registry_nominal_$CLUSTERID.txt
