...
source /afs/cern.ch/work/v/vveckaln/private/CMSSW_8_0_26_patch1/src/TopLJets2015/TopAnalysis/condor/makeplots/run_job.sh /eos/user/v/vveckaln/analysis_MC13TeV_TTJets/HADDChunks/ /eos/user/v/vveckaln/analysis_MC13TeV_TTJets/plots M_phi_PV_bckg_PFPtgt0p5GeV_reco_scnd_leading_b M_pull_angle_PFNgt20_gen_leading_b_scnd_leading_b_DeltaRgt1p0 nominal /eos/user/v/vveckaln/analysis_MC13TeV_TTJets/HADDChunks/MC13TeV_TTJets.root $CLUSTERID 
#EXIT_CODE=$?
