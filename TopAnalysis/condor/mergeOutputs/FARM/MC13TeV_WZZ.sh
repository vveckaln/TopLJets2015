...
source /afs/cern.ch/work/v/vveckaln/private/CMSSW_8_0_26_patch1/src/TopLJets2015/TopAnalysis/condor/mergeOutputs/run_job.sh /eos/user/v/vveckaln/analysis_MC13TeV_TTJets /eos/user/v/vveckaln/analysis_MC13TeV_TTJets MC13TeV_WZZ $CLUSTERID 
#EXIT_CODE=$?
